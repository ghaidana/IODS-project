...
-   Proportion of trace is the percentage of separation achieved by each discriminant function. So, the first discrimination function 94.79 percent of separation.
...
Here, we have the cross tabulation of the real and predicted categories. Ideally, the data should all belong to the same groups (towns with low crime rate should be predicted to have low crime rate). Most of the towns are classified correctly, but some are classified incorrectly. For example, out of 27 towns with high crime rate, 26 are predicted to have high crime rate while 1 town is predicted to have medium high crime rate.
